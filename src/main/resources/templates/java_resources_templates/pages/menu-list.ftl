...
<div id="app">
        ...
        <el-table :data="tableData"
            ...
            <el-table-column prop="name" label="名称" width="150">
                <template slot-scope="scope">
                    <i style="font-size: 12px;" :class="scope.row.icon"></i>
            ...
            <el-table-column prop="href" label="链接地址">
                <template slot-scope="scope">
                    <el-link v-if="!(scope.row.children && scope.row.children.length > 0)" style="font-size: 12px" icon="el-icon-link" :href="scope.row.href == '' ? 'javascript:;' : scope.row.href">查看</el-link>
                    <span v-else></span>
                </template>
            </el-table-column>
    ...
    <#-- 页码 -->
    <el-pagination style="text-align: center; margin-top: 10px; display: none"
