...
<div id="app">
    ...
    <div class="search-div">
        <el-form :model="searchForm" label-width="60px" label-position="left" size="small" :inline="true">
            ...
            <el-form-item>
                <el-input maxlength="32" placeholder="用户名" v-model="searchForm.susername" clearable @clear="searchData"></el-input>
            </el-form-item>
    ...
    <template>
        <el-table :data="tableData"
            ...
            <el-table-column prop="administrator" label="是否管理员" align="center">
                <template slot-scope="scope">
                    <i :class="scope.row.administrator ? 'el-icon-check' : 'el-icon-close'"></i>
                </template>
            </el-table-column>
